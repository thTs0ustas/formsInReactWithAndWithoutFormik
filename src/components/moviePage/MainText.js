...
import { TextContainer, MainTitle, SectionTitle, Paragraph, Description, DaysDiv, DaysButton, SessionDiv, SessionButton } from './styledComponents/MainTextStyles';
...
const MainText = () => {
    ...
    return (
        <TextContainer>
            ...
            <Description>A criminal pleads insanity and is admitted to a mental institution, where he rebels against the oppressive nurse and rallies up the scared patients.</Description>
